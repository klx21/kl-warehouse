...
(function () {
    ...
    function kCardsBox(kCBE, kCBD, kCBCN) {
        ...
        function listenOnScroll(oScope, jqElement) {
            ...
            if (angular.isUndefined(oScope.sAutoLoadMore)) {
            ...
            } else if (oScope.sAutoLoadMore.trim().toLowerCase() !== 'false') {

                if (jqElement.parent(oScope.sAutoLoadMore).is(jqElement.parent())) {

                    jqElement.parent().on('scroll', scrollWithinParent);
                } else {

                    jqElement.parents(oScope.sAutoLoadMore).on('scroll', scrollWithPage);
                }
            }
